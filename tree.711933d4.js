...
exports.default = _default;
},{"../colors.js":"node_modules/d3-scale-chromatic/src/colors.js","../ramp.js":"node_modules/d3-scale-chromatic/src/ramp.js"}],"node_modules/d3-scale-chromatic/src/sequential-multi/cubehelix.js":[function(require,module,exports) {
"use strict";
...
},{"d3-selection":"node_modules/d3-selection/src/index.js"}],"node_modules/d3-selection-multi/src/selection/styles.js":[function(require,module,exports) {
"use strict";
...
function _default(map, priority) {
  return (typeof map === "function" ? stylesFunction : stylesObject)(this, map, priority == null ? "" : priority);
}
},{"d3-selection":"node_modules/d3-selection/src/index.js"}],"node_modules/d3-selection-multi/src/selection/properties.js":[function(require,module,exports) {
"use strict";
...
},{"d3-selection":"node_modules/d3-selection/src/index.js"}],"node_modules/d3-selection-multi/src/transition/attrs.js":[function(require,module,exports) {
"use strict";
...
function attrsFunction(transition, map) {
  return transition.each(function () {
    var x = map.apply(this, arguments),
        t = (0, _d3Selection.select)(this).transition(transition);
...
},{"d3-selection":"node_modules/d3-selection/src/index.js"}],"node_modules/d3-selection-multi/src/transition/styles.js":[function(require,module,exports) {
"use strict";
...
},{"d3-selection":"node_modules/d3-selection/src/index.js"}],"node_modules/d3-selection-multi/index.js":[function(require,module,exports) {
"use strict";
...
var _attrs = _interopRequireDefault(require("./src/selection/attrs"));

var _styles = _interopRequireDefault(require("./src/selection/styles"));

var _properties = _interopRequireDefault(require("./src/selection/properties"));

var _attrs2 = _interopRequireDefault(require("./src/transition/attrs"));

var _styles2 = _interopRequireDefault(require("./src/transition/styles"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_d3Selection.selection.prototype.attrs = _attrs.default;
_d3Selection.selection.prototype.styles = _styles.default;
...
},{"d3-selection":"node_modules/d3-selection/src/index.js","d3-transition":"node_modules/d3-transition/src/index.js","./src/selection/attrs":"node_modules/d3-selection-multi/src/selection/attrs.js","./src/selection/styles":"node_modules/d3-selection-multi/src/selection/styles.js","./src/selection/properties":"node_modules/d3-selection-multi/src/selection/properties.js","./src/transition/attrs":"node_modules/d3-selection-multi/src/transition/attrs.js","./src/transition/styles":"node_modules/d3-selection-multi/src/transition/styles.js"}],"node_modules/parcel-bundler/src/builtins/_empty.js":[function(require,module,exports) {
...
function writeJSON(path, data) {
  ...
  fs_1.writeFileSync(path, minify ? JSON.stringify(data) : JSON.stringify(data, null, 3));
}

exports.writeJSON = writeJSON;
},{"fs":"node_modules/parcel-bundler/src/builtins/_empty.js"}],"parse-ctors.ts":[function(require,module,exports) {
"use strict";
...
var Tree = function Tree(ctor, path, depth) {
...
exports.trees = [];
var visitedScopes = new Set();

function ctorChain(ctor) {
  var prototype = ctor.prototype; // Proxy

  if (prototype === undefined) {
    return [ctor];
  }

  var proto = Object.getPrototypeOf(prototype); // Object
  // Object.create(null)
...
function parse(scope, basePath, blacklist) {
  ...
  Object.getOwnPropertyNames(scope).filter(function (k) {
    return utils_1.not(['prototype', 'constructor'].includes(k));
  }).forEach(function (k) {
    var x = scope[k];

    if (utils_1.isConstructor(x)) {
      var nodes = exports.trees;
      ctorChain(x).forEach(function (ctor, depth) {
        var name = ctor === null ? 'null' : ctor.name;
...
function parseModule() {
  ...
  if (args.length === 3) {
    var name = args[0],
        _mod = args[1],
        _blacklist = args[2];
    parse(_mod, name + '::', _blacklist);
  }
}

exports.parseModule = parseModule;
},{"./utils":"utils.ts"}],"parse-ctors.web.ts":[function(require,module,exports) {
...
var parse_ctors_1 = require("./parse-ctors");

var blacklist = [// iframe parent
/^parent\./, // timer methods
/^(set|clear)(Immediate|Interval|Timeout)$/, // constructors with no name
/(::|\.)$/, // constructors with name starting with underscore, lowercase
/(::|\.)(?!null)(_|[a-z])/];

function parse(global) {
  parse_ctors_1.parseModule(global, blacklist);
  parse_ctors_1.trees.forEach(function (tree) {
    parse_ctors_1.pruneTree(tree, ['ctor', 'depth']);
    parse_ctors_1.sortTree(tree);
  });
  return parse_ctors_1.trees;
}

exports.parse = parse;
},{"./parse-ctors":"parse-ctors.ts"}],"tree.ts":[function(require,module,exports) {
"use strict";
...
var parse_ctors_web_1 = require("./parse-ctors.web");

var utils_1 = require("./utils"); // controls


var circleRadius = 8;
var fontSize = 17;
var duration = 300;
var nodeSize = [4.5 * circleRadius, 300];
var scaleExtent = [0.2, 2];
var pad = 0.5 * circleRadius;
var width = window.innerWidth;
var height = window.innerHeight; // d3 generators

var treeGenerator = d3.tree().nodeSize(nodeSize);
var linkGenerator = d3.linkHorizontal().x(function (d) {
  return d.x;
}).y(function (d) {
  return d.y;
});
var zoomBehavior = d3.zoom().scaleExtent(scaleExtent).on('zoom', function () {
...
function loadCtors() {
  ...
  if (mode === null || utils_1.not(['core', 'node', 'browser'].includes(mode))) {
    mode = 'core';
  ...
  if (mode === 'browser') {
    ...
    return Promise.resolve(parse_ctors_web_1.parse(iframe.contentWindow.window));
  }

  return d3.json("./ctors.".concat(mode, ".json"));
} // render tree
...
function render(base) {
  ...
  var transition = d3.transition().duration(duration); // links

  var $links = $linksGroup.selectAll('path').data(root.links().slice(2), function (d) {
    return String(d.target.id);
  });
  $links.enter().append('path').attrs({
    d: function d() {
      var o = {
        x: base._x,
        y: base._y
    ...
    stroke: 'lightgray',
    'stroke-width': 2
  }).merge($links).transition(transition).attrs({
    d: linkGenerator
  }).styles({
    opacity: 1
  });
  $links.exit().transition(transition).attrs({
    d: function d(_d) {
      var ancestor = _d.source.ancestors().find(function (a) {
  ...
  var $nodes = $nodesGroup.selectAll('g').data(root.descendants().slice(1), function (d) {
    return String(d.id);
  }); // nodes@enter

  var $nodesEnter = $nodes.enter().append('g').styles({
    transform: "translate(".concat(base._y, "px, ").concat(base._x, "px)"),
    opacity: 0
  }).on('dblclick', function () {
    d3.event.stopImmediatePropagation();
  }); // nodes@enter#labelboxes

  $nodesEnter.append('rect').styles({
    fill: 'white',
    opacity: 0.9,
    rx: 4
  }); // nodes@enter#labels

  $nodesEnter.append('text').attrs({
    dy: 4
  }).styles({
  ...
  $nodesEnter.append('circle').styles({
    r: circleRadius,
    cursor: 'pointer',
    ...
    d._x = d.x;
    d._y = d.y;
    render(d); // bring base node into focus

    var datum = d3.select(d3.event.target).datum();
    var transition = d3.transition().duration(2 * duration);
    zoomBehavior.transform($svg.transition(transition), d3.zoomIdentity.translate(0.5 * width - datum.x, 0.5 * height - datum.y));
  }); // nodes@enter+update

  var $nodesEnterUpdate = $nodesEnter.merge($nodes);
  ...
  $nodesEnterUpdate.selectAll('text').text(function (d) {
    return d.data.path + (d.isCollapsed() ? " #".concat(d.totalDescendants) : '');
  }).attrs({
    dx: function dx(d) {
      return (circleRadius + pad) * (d.isLeaf || d.isCollapsed() ? 1 : -1);
    }
  }).styles({
    'font-style': function fontStyle(d) {
      return d.isCollapsed() ? 'italic' : 'normal';
    },
    'text-anchor': function textAnchor(d) {
      return d.isLeaf || d.isCollapsed() ? 'start' : 'end';
    }
  }); // nodes@enter+update#labelboxes

  $nodesEnterUpdate.nodes().forEach(function (node) {
    var $node = d3.select(node);
    var text = $node.select('text').node();
    var bbox = text.getBBox();
    $node.select('rect').styles({
      x: bbox.x - pad,
      y: bbox.y,
  ...
  $nodesEnterUpdate.selectAll('circle').styles({
    fill: function fill(d) {
      return d.isCollapsed() ? 'whitesmoke' : 'deepskyblue';
    },
    stroke: function stroke(d) {
      return d.isCollapsed() ? 'deepskyblue' : 'none';
    }
  }); // nodes@exit

  $nodes.exit().transition(transition).styles({
    opacity: 0,
    transform: function transform(d) {
      var ancestor = d.ancestors().find(function (a) {
        return a.isCollapsed();
      }) || root;
      return "translate(".concat(ancestor.x, "px, ").concat(ancestor.y, "px)");
    }
  }).remove();
}

var $svg = d3.select(document.body).append('svg').styles({
  width: width,
  height: height
}).on('mousedown', function () {
...
var $zoomPanGroup = $svg.append('g').styles({
  'will-change': 'transform'
});
var $linksGroup = $zoomPanGroup.append('g');
var $nodesGroup = $zoomPanGroup.append('g');
zoomBehavior($svg);
zoomBehavior.translateBy($svg, 200 - nodeSize[1], 0.5 * height); // root node

var root;
loadCtors().then(function (ctors) {
  root = treeGenerator(d3.hierarchy({
    path: 'ROOT',
    children: ctors
  ...
  root.descendants().forEach(function (d, i) {
    // @ts-ignore
    d.id = i; // save children for recovering collapsed nodes
    ...
    d.isCollapsed = function () {
      return utils_1.not(d._children === d.children);
    };
  });
  render(root);
...
},{"d3":"node_modules/d3/index.js","d3-selection-multi":"node_modules/d3-selection-multi/index.js","./parse-ctors.web":"parse-ctors.web.ts","./utils":"utils.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","tree.ts"], null)
